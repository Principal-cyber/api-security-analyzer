...
Профессиональный инструмент для автоматического тестирования безопасности API согласно OWASP Top 10. Специализирован для анализа банковских API открытых банковских систем.
